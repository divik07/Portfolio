  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto mb-16">
        <div className="md:float-right md:w-1/3 mb-8 md:mb-0 md:ml-8">
        ...
        <motion.div
          className="text-gray-200 text-lg md:text-xl leading-relaxed text-justify space-y-6"
      ...
      <div className="max-w-5xl mx-auto mt-12">
        <motion.h3
          className="text-3xl font-semibold text-blue-300 mb-6 text-center"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
        ...
        >
          {patents.map((patent, idx) => (
            <SwiperSlide key={idx} className="flex flex-col items-center px-2">
              ...
              <p className="text-center text-gray-400 italic mt-2 text-sm sm:text-base">
                {captions[idx]}
              </p>
            </SwiperSlide>
          ))}
